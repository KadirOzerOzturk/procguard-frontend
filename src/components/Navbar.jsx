    ...
    <nav className={`text-light shadow-md sticky top-0 z-50 transition-colors duration-300 ${scrolled ? "bg-dark-contrast" : "bg-transparent"}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-20 items-center">
          ...
          <div>
            <Link to="/login" className="hidden md:inline-block  text-light hover:text-primary px-3 py-1 rounded-xl text-lg font-semibold shadow-lg transition">
              Login
            </Link>
            <Link to="/register" className="hidden md:inline-block bg-primary hover:bg-primary-light  text-light px-3 py-1 rounded-xl text-lg font-semibold shadow-lg transition ml-4">
            Register
            </Link>
